...
class clustering_metrics():
    ...
    def clusteringAcc(self):
        ...
        if numclass1 != numclass2:
            print('Class Not equal, Error!!!!,true:{}, predict:{}'.format(numclass1,numclass2))
            return 0
    ...
    def evaluationClusterModelFromLabel(self):
        ...
        return [acc, f1_macro, precision_macro, recall_macro, f1_micro, precision_micro, recall_micro, nmi, adjscore]
